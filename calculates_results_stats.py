...
def calculates_results_stats(results_dic):
    ...
    n_dog_img = 0 # number of Dog Images
    ...
    for file in results_dic:
        if results_dic[file][3] == 1:
            n_dog_img += 1
            if results_dic[file][4] == 1:
                n_correct_dogs += 1
            if results_dic[file][2] == 1:
                n_correct_breed += 1
        elif results_dic[file][3] == 0:
            n_notdogs_img += 1
            if results_dic[file][4] == 0:
                n_correct_notdogs += 1
        if results_dic[file][2] == 1:
            n_match += 1

    results_stats_dic['n_images'] = n_images
    results_stats_dic['n_dogs_img'] = n_dog_img
    ...
    results_stats_dic['pct_correct_dogs'] = n_correct_dogs / n_dog_img * 100
    results_stats_dic['pct_correct_breed'] = n_correct_breed / n_dog_img * 100
    if n_notdogs_img > 0:
